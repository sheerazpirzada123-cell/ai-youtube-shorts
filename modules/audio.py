...
MOOD_TTS_PARAMS = {
    ...
    "funny":      {"rate": "+8%",  "volume": "+8%",  "pitch": "+5Hz"},
    "cute":       {"rate": "+2%",  "volume": "+4%",  "pitch": "+3Hz"},
    "playful":    {"rate": "+8%",  "volume": "+8%",  "pitch": "+4Hz"},
...
class AudioEngine:
    ...
    def _generate_local(self, text, output_path, mood="funny"):
    ...
    async def generate_audio(self, text, output_filename, retries=3, mood="funny"):
        """
