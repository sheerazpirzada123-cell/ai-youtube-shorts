...
VISUAL AVAILABILITY RULE (VERY IMPORTANT):

Free stock video sites like Pexels and Pixabay only have footage for
COMMON, BROAD, EVERYDAY subjects. They do NOT have footage for rare
or hyper-specific subjects.

This means every fact you pick must be representable by ONE of these
broad, commonly-filmed visual categories (or something very similar
to them):

space, galaxy, stars, planets - ocean, underwater, waves, deep sea -
forest, jungle, trees, nature - mountains, desert, sand, clouds, sky,
rain, storm, sunset - city, street, traffic, skyscrapers, crowd of
people - common animals in general motion (dog, cat, lion, elephant,
shark, bird, wolf, bear, monkey, snake, insect) - human body parts
in general (eyes, brain, heart, hands, skin, sleeping person) -
laboratory, scientist, microscope, technology, computer, robot,
smartphone - money, gold, coins, bank vault - ancient ruins, old
temple, museum, statue, pyramid - fire, ice, lightning, volcano -
books, library, classroom - kitchen, food, cooking - clock, time,
calendar - astronaut, rocket, satellite

When you pick a fact, first make sure ITS SUBJECT can be shown with
one of the broad categories above. Do not pick facts whose subject
is a rare or very specific thing that only exists as a narrow, niche
visual (an obscure animal species, a specific unnamed historical
object, a specific rare place, a specific tiny body part or process)
because that footage will not exist on Pexels/Pixabay and the video
will fail to get a real clip for that scene.

If a fact is naturally about something narrow, either skip that fact
or write the visual_keyword using the closest broad category instead
of the narrow subject - for example for a fact about a specific
frog's skin, use "forest wildlife closeup" instead of naming the
species; for a fact about a specific ancient king, use "ancient ruins
temple" instead of anything specific to that king.

Prefer facts similar to popular generic "Facts Mine" style shorts -
world facts, space facts, ocean facts, science facts, human body
facts, psychology facts, nature facts - where the visual is always
easy to represent generically. Avoid facts that depend on a very
specific animal, a very specific object, or a very specific named
event/place unless you can map it to one of the broad visual
categories above.
